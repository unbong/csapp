...
long allOddBits(long x) {
    ...
    // 01010101.  and operate
    long oddBits = x & 0xAAAAAAAAAAAAAAAAL;
...
long remainderPower2(long x, long n) {
    ...
    long inverse = x & 0x8000000000000000;
    inverse = inverse >> 62;
    ...
    long modNum = 1 << n;
    modNum = modNum + 0xFFFFFFFFFFFFFFFF;
...
long bitMask(long highbit, long lowbit) {
    ...
    // FFFF... left shift lowbit
    long low = 0xFFFFFFFFFFFFFFFFL << lowbit;
    // FFFF left shifthighbit +1
