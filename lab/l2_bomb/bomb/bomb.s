...
0000000000400da0 <main>:
  400da0:	53                   	push   %rbx                         
  400da1:	83 ff 01             	cmp    $0x1,%edi                  # 如果第一个参数 不等与 1
  400da4:	75 10                	jne    400db6 <main+0x16>         
  400da6:	48 8b 05 9b 29 20 00 	mov    0x20299b(%rip),%rax        # 603748 <stdin@@GLIBC_2.2.5>  读取 参数
  400dad:	48 89 05 b4 29 20 00 	mov    %rax,0x2029b4(%rip)        # 603768 <infile>
  400db4:	eb 63                	jmp    400e19 <main+0x79>         # 跳到 initialize_bomb函数
  400db6:	48 89 f3             	mov    %rsi,%rbx                  # 复制第二个参数到rbx
  400db9:	83 ff 02             	cmp    $0x2,%edi                  # 如果第一个参数 不等于 2
  400dbc:	75 3a                	jne    400df8 <main+0x58>         # 跳到 400df8
  400dbe:	48 8b 7e 08          	mov    0x8(%rsi),%rdi             # 第二个参数是数组 将第二个值复制到 rdi 
  400dc2:	be b4 22 40 00       	mov    $0x4022b4,%esi             # 4203188 esi
  400dc7:	e8 44 fe ff ff       	callq  400c10 <fopen@plt>         # fopen 
  400dcc:	48 89 05 95 29 20 00 	mov    %rax,0x202995(%rip)        # 603768 <infile>
  400dd3:	48 85 c0             	test   %rax,%rax                  # rax是否为0 
  400dd6:	75 41                	jne    400e19 <main+0x79>         # 当部位0时 调用 initialize_bomb
  400dd8:	48 8b 4b 08          	mov    0x8(%rbx),%rcx             # 第二个参数的复本（rbx） 的第二个元素复制到 rcx
  400ddc:	48 8b 13             	mov    (%rbx),%rdx                # 第二个参数的复本（rbx） 的第一个元素复制到 rdx
  400ddf:	be b6 22 40 00       	mov    $0x4022b6,%esi             # 4203190 复制到 rsi
  400de4:	bf 01 00 00 00       	mov    $0x1,%edi                  # 1 复制到 第一个参数
  400de9:	e8 12 fe ff ff       	callq  400c00 <__printf_chk@plt>  # 调用print chk
  400dee:	bf 08 00 00 00       	mov    $0x8,%edi                  # 8 复制到 第一个参数
  400df3:	e8 28 fe ff ff       	callq  400c20 <exit@plt>          # 调用exit 
  400df8:	48 8b 16             	mov    (%rsi),%rdx                # exit返回值写入到rdx
  400dfb:	be d3 22 40 00       	mov    $0x4022d3,%esi             # 4203219写入到第二个参数
  400e00:	bf 01 00 00 00       	mov    $0x1,%edi                  # 1 复制到第一个参数
  400e05:	b8 00 00 00 00       	mov    $0x0,%eax                  # 0 复制到 eax
  400e0a:	e8 f1 fd ff ff       	callq  400c00 <__printf_chk@plt>  # 调用printf——chk
  400e0f:	bf 08 00 00 00       	mov    $0x8,%edi                  # 8 复制到第一个参数
  400e14:	e8 07 fe ff ff       	callq  400c20 <exit@plt>          # 调用exit 
  400e19:	e8 84 05 00 00       	callq  4013a2 <initialize_bomb>   # 调用 initialize_bomb
  400e1e:	bf 38 23 40 00       	mov    $0x402338,%edi             # 4203320 第一个参数
  400e23:	e8 e8 fc ff ff       	callq  400b10 <puts@plt>          # 调用puts
  400e28:	bf 78 23 40 00       	mov    $0x402378,%edi
  400e2d:	e8 de fc ff ff       	callq  400b10 <puts@plt>
  400e32:	e8 67 06 00 00       	callq  40149e <read_line>       
                                                                  # ¥¥¥¥----------¥¥¥¥¥¥¥¥¥¥¥¥¥
  400e37:	48 89 c7             	mov    %rax,%rdi                  # read line 的返回值 写入到 rdi phase 1的第一个参数
...
0000000000400efc <phase_2>:
  ...
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> # go to loop
...
0000000000400f43 <phase_3>:                                   # switch
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx         # 第一个本地变量
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx         # 第二个本地变量 2
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi         # %d %d       
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax              # 如果按照上%d %d 格式输入正确 
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>  # 
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)         # 第二个参数与7 比较
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>  # 如果大于7 
...
0000000000400fce <func4>:                                 # 递归 
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax          edx 14  esi 0 
  400fd4:	29 f0                	sub    %esi,%eax          # eax=  第3个参数- 第二个参数 14- x eax = 0
  400fd6:	89 c1                	mov    %eax,%ecx          # ecx = eax 14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx         # （arg3- arg2）逻辑右移31 写道ecx (14-x) >> 31     ecx = 0 
  400fdb:	01 c8                	add    %ecx,%eax          # eax = eax+ecx                 ( 14-x + (14-x) >> 31 )  14 
  400fdd:	d1 f8                	sar    %eax               # 算术右移 eax                    ( 14-x + (14-x) >> 31 ) >>1   eax = 7 
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = rax+rsi    ( 14-x + (14-x) >> 31 ) >>1  + x       ecx = 7
  400fe2:	39 f9                	cmp    %edi,%ecx          # 
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # 如果ecx 小于等于第一个参数 则 
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx     # 如果ecx 大于第一个参数 edx = rcx -1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>      # 递归调用 func4
  400fee:	01 c0                	add    %eax,%eax           # eax = 2* eax 递归调用后结构*2
  400ff0:	eb 15                	jmp    401007 <func4+0x39> #  goto return
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax            # eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx            # ecx edi
  400ff9:	7d 0c                	jge    401007 <func4+0x39>  # 如果ecx大于等于 edi goto return
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi       # esi = rcx + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>       # 递归调用 func4
...
000000000040100c <phase_4>:
  ...
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)             # rsp + 8 第一个参数 rsp+c 第二个参数
  401033:	76 05                	jbe    40103a <phase_4+0x2e>      # 如果第一个参数小于等于 14
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                  # 14复制到 edx 第三个参数
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                  # 0 复制到 esi 第二个参数
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi             # pahse4的第一个参数复制到edi 第一个参数
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx          # 第一个参数 复制到 rdi  rbx flyers
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax      #  rax 3512601233528112896
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)    #  0x18(%rsp)  3512601233528112896
  ...
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
                                                        # ifblock 
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx    # rbx flyers # $
  40108f:	88 0c 24             	mov    %cl,(%rsp)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx      # edx 114
  ...
  4010c2:	85 c0                	test   %eax,%eax                # 如果eax为零 end ifbloclk
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>    # end ifbloclk 
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>    # goto   ifbloclk 
...
00000000004010f4 <phase_6>:
  ...
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d         # r12d = 0
                                                      # loop2   循环6次 
  401114:	4c 89 ed             	mov    %r13,%rbp          # rbp = rsp  (¥001) 
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax     # eax = rsp    (1) 
  40111b:	83 e8 01             	sub    $0x1,%eax          # eax = eax -1  = 0 
  40111e:	83 f8 05             	cmp    $0x5,%eax          # eax  < 5 
  401121:	76 05                	jbe    401128 <phase_6+0x34> #   if eax <= 5  
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d            #    r12d = r12d+1  0->1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d            # r12d < 6
  401130:	74 21                	je     401153 <phase_6+0x5f> # if r12d == 6 goto break loop2
  401132:	44 89 e3             	mov    %r12d,%ebx            # r12d != 6 -> ebx = r12d ebx =1   
                                                              # loop
                                                              # 这段循环把第一个输入值的索引开始循环比较是否存在与第一个输入值一样的值如果存在就爆炸
  401135:	48 63 c3             	movslq %ebx,%rax              #  int to long rax = ebx rax = 1
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax     # eax = rsp + 4 rax  rsp(保存了我写入的6位数) = 1  eax = 2
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)         # (rbp) < eax rbp = 2
  40113e:	75 05                	jne    401145 <phase_6+0x51>  # if (rbp) != eax goto 401145
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>  # ifn(rbp) == eax 爆炸
  401145:	83 c3 01             	add    $0x1,%ebx              # ebx = ebx +1
  401148:	83 fb 05             	cmp    $0x5,%ebx              # ebx < 5
  40114b:	7e e8                	jle    401135 <phase_6+0x41>  # if ebx <= 5 goto loop

  40114d:	49 83 c5 04          	add    $0x4,%r13              # r13 = r14 +4  r13 是栈顶位置 即为输入的6位的第一个值
  401151:	eb c1                	jmp    401114 <phase_6+0x20>  # goto loop2
                                                            # break loop2
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi        # rsi = rsp + 24 = 0
  401158:	4c 89 f0             	mov    %r14,%rax              # rax = r14     r14 = 1 rax = 1
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx              # ecx = 7       ecx =7 
                                                          # loop 3
  401160:	89 ca                	mov    %ecx,%edx              # edx = ecx = 7
  401162:	2b 10                	sub    (%rax),%edx            # edx = edx -(rax) = 6  # rax 指向栈顶位置 输入的6位值的一个
  401164:	89 10                	mov    %edx,(%rax)            # (rax) = edx  = 6  将栈顶的值修改 
  401166:	48 83 c0 04          	add    $0x4,%rax              # rax = rax + 4 
  40116a:	48 39 f0             	cmp    %rsi,%rax              # rax - rsi
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  # if rax != rsi goto loop3

  40116f:	be 00 00 00 00       	mov    $0x0,%esi              # if rax == rsi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>  # goto 401197
                                                            # loop4
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx         # rdx = rdx+8
  40117a:	83 c0 01             	add    $0x1,%eax              # rax = eax +1
  40117d:	39 c8                	cmp    %ecx,%eax              # eax < ecx
  40117f:	75 f5                	jne    401176 <phase_6+0x82>  # if eax != ecx  goto loop4
  401181:	eb 05                	jmp    401188 <phase_6+0x94>  # if eax == ecx goto 401188
                                                            # loop5
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx         # edx = 0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # rdx = (32 + rsp + 2 rsi)
  40118d:	48 83 c6 04          	add    $0x4,%rsi              # rsi = rsi +4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi             # rsi < 24
  401195:	74 14                	je     4011ab <phase_6+0xb7>  # if rsi == 24 goto xxxxxxx
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx     # if rsi != 24  ecx = (rsp + rsi)
  40119a:	83 f9 01             	cmp    $0x1,%ecx              # ecx < 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  # if ecx <= 1 goto loop5
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax              # if ecx > 1 -> eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx         # edx = 0x6032d0 332 
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>  # goro loop 4
                                                          # xxxxxxx
  ...
  4011ba:	48 89 d9             	mov    %rbx,%rcx              # rcx = rbx
                                                          # loop6
  4011bd:	48 8b 10             	mov    (%rax),%rdx            # rbx = (rax)
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)         # (rcx+8) = rdx
  4011c4:	48 83 c0 08          	add    $0x8,%rax              # rax = rax +8
  4011c8:	48 39 f0             	cmp    %rsi,%rax              # rax < rsi
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>  # if rax == rsi goto 4011d2
  4011cd:	48 89 d1             	mov    %rdx,%rcx              # if rax != rsi -> rcx = rdx
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>   #  if eax >= rbx goto end 
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>    #  
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx           # end
  4011f2:	83 ed 01             	sub    $0x1,%ebp                # ebp = ebp-1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>    # if !=   got  loop7
  4011f7:	48 83 c4 50          	add    $0x50,%rsp               # rsp = rap + 80
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
...
000000000040131b <string_length>:                                       #   第一个参数 第二个参数  
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)                      #   第一个参数的值与0 比较 判断是否为空
  40131e:	74 12                	je     401332 <string_length+0x17>      #   
  401320:	48 89 fa             	mov    %rdi,%rdx                        #  循环的方式获取字符串的大小
  ...
  401332:	b8 00 00 00 00       	mov    $0x0,%eax                        # 返回 0 
  401337:	c3                   	retq   
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx                        # 第一个参数复制到 rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp                        # 第二个参数复制到 rbp
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>           # 
  401347:	41 89 c4             	mov    %eax,%r12d                       # 第一个参数 字符串长度大小 复制到r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi                        # 第二个参数复制到 rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>           # 获取到第二个参数的长度
  401352:	ba 01 00 00 00       	mov    $0x1,%edx                        #  1 复制到edx
  401357:	41 39 c4             	cmp    %eax,%r12d                       #  第二个参数长度与第一个参数长度 比较
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>  # 如果不等于 结束函数 并返回1   
  40135c:	0f b6 03             	movzbl (%rbx),%eax                      # 如果相等 第一个参数的内存值写入到rax  
  40135f:	84 c0                	test   %al,%al                          # 第一个参数的值是否为 空 null或结束
  401361:	74 25                	je     401388 <strings_not_equal+0x50>  # 如果相等 则结束函数 且返回0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al                    # 第二个参数的值与 第一个参数的值比较
                                                                      # 循环判断两个参数的字符
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>  # 如果相等则表示 如果全都想等返回0
...
000000000040145c <read_six_numbers>:
  ...
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)     # rsp + 8 的内存值 被设为rax
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax    # rax = rsi + 16;
  401474:	48 89 04 24          	mov    %rax,(%rsp)        # rsp 的内存值被设为 rax
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9      # r9 = rsi+ 12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8      # r8 = rsi +8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi     # rsi 
...
000000000040149e <read_line>:                                     # 递归执行read——line
  40149e:	48 83 ec 08          	sub    $0x8,%rsp                  # 栈 使用 8 字节
  4014a2:	b8 00 00 00 00       	mov    $0x0,%eax                  #  初始化返回值
  4014a7:	e8 4d ff ff ff       	callq  4013f9 <skip>              #  调用skip  取得返回值用语下一步判断
  4014ac:	48 85 c0             	test   %rax,%rax                  # rax （返回值）是否为零
  4014af:	75 6e                	jne    40151f <read_line+0x81>    # 不为零 执行read line
  ...
  4014bf:	75 14                	jne    4014d5 <read_line+0x37>    # 
                                                                # 如果等某个值得话结束该函数 并推出
  4014c1:	bf d5 25 40 00       	mov    $0x4025d5,%edi             # 复制到一个参数
  ...
  4014da:	e8 01 f6 ff ff       	callq  400ae0 <getenv@plt>        # getenv
  4014df:	48 85 c0             	test   %rax,%rax                  # 判断getenv返回值是否为空
  4014e2:	74 0a                	je     4014ee <read_line+0x50>    # 如果返回值为空 调用read line
  4014e4:	bf 00 00 00 00       	mov    $0x0,%edi                  # 如果不为空 第一个参数写 0
  4014e9:	e8 32 f7 ff ff       	callq  400c20 <exit@plt>          # 结束
  ...
  401501:	e8 f3 fe ff ff       	callq  4013f9 <skip>              # 调用 skip
  401506:	48 85 c0             	test   %rax,%rax                  # skip 返回值是否为零
  401509:	75 14                	jne    40151f <read_line+0x81>    # 不为零 跳到40151f
                                                                # 结束程序
  ...
  401525:	48 63 c2             	movslq %edx,%rax                  # int to long 算术增大
  401528:	48 8d 34 80          	lea    (%rax,%rax,4),%rsi         # 
  40152c:	48 c1 e6 04          	shl    $0x4,%rsi                  # 逻辑左移 4位
  ...
  401548:	48 f7 d1             	not    %rcx                       # 非rcx
  40154b:	48 83 e9 01          	sub    $0x1,%rcx                  # rcx 减1
  40154f:	83 f9 4e             	cmp    $0x4e,%ecx                 # rcx与 字符N 78比较
  401552:	7e 46                	jle    40159a <read_line+0xfc>    # 如果小于等于 跳到 40159a
  401554:	bf fe 25 40 00       	mov    $0x4025fe,%edi             # 给puts jia
  ...
  401573:	48 bf 2a 2a 2a 74 72 	movabs $0x636e7572742a2a2a,%rdi   # 复制绝对数到rdi 
  40157a:	75 6e 63 
  ...
  401595:	e8 a0 fe ff ff       	callq  40143a <explode_bomb>      # explode_bomb调用 
  40159a:	83 e9 01             	sub    $0x1,%ecx                  # 
  40159d:	48 63 c9             	movslq %ecx,%rcx                  # 
  4015a0:	48 63 c2             	movslq %edx,%rax                  # edx 
  4015a3:	48 8d 04 80          	lea    (%rax,%rax,4),%rax         # rax = 5 rax
  4015a7:	48 c1 e0 04          	shl    $0x4,%rax                  # rax = 5 * 16 rax
